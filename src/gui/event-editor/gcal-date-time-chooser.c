...
normalize_time_popover (GcalDateTimeChooser *self)
{
  ...
  g_signal_handlers_block_by_func (self->am_toggle_button, on_period_toggle_button_toggled_cb, self);
  g_signal_handlers_block_by_func (self->pm_toggle_button, on_period_toggle_button_toggled_cb, self);

  gtk_toggle_button_set_active (new_hour < 12 ? self->am_toggle_button : self->pm_toggle_button, TRUE);
  ...
  g_signal_handlers_unblock_by_func (self->am_toggle_button, on_period_toggle_button_toggled_cb, self);
  g_signal_handlers_unblock_by_func (self->pm_toggle_button, on_period_toggle_button_toggled_cb, self);
...
on_spin_buttons_value_changed_cb (GcalDateTimeChooser *self)
{
  ...
  switch (self->time_format)
    ...
    case GCAL_TIME_FORMAT_12H:
      if (hour == 12)
        hour = 0;
      if (gtk_toggle_button_get_active (self->pm_toggle_button))
        hour += 12;
      break;
                                ...
                                GcalDateTimeChooser *self)
{
  if (gtk_toggle_button_get_active (self->am_toggle_button))
    gtk_toggle_button_set_active (self->pm_toggle_button, TRUE);
  else
    gtk_toggle_button_set_active (self->am_toggle_button, TRUE);
}
                                    ...
                                    GcalDateTimeChooser *self)
{
  ...
  if (button == self->am_toggle_button)
...
gcal_date_time_chooser_class_init (GcalDateTimeChooserClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, GcalDateTimeChooser, period_toggle_box);
  gtk_widget_class_bind_template_child (widget_class, GcalDateTimeChooser, am_toggle_button);
  gtk_widget_class_bind_template_child (widget_class, GcalDateTimeChooser, pm_toggle_button);
  ...
  gtk_widget_class_bind_template_callback (widget_class, on_period_toggle_button_toggled_cb);
}
                                        ...
                                        GcalTimeFormat time_format)
{
  ...
  gtk_widget_set_visible (self->period_toggle_box, time_format == GCAL_TIME_FORMAT_12H);
