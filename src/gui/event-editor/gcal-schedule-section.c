                ...
                WidgetState         *state)
{
  ...
  gtk_toggle_button_set_active (state->schedule_type_all_day ? self->all_day_toggle : self->time_slot_toggle,
                                TRUE);
  ...
  g_signal_handlers_unblock_by_func (self->all_day_toggle, on_schedule_type_changed_cb, self);
  g_signal_handlers_unblock_by_func (self->time_slot_toggle, on_schedule_type_changed_cb, self);
}
...
gcal_schedule_section_class_init (GcalScheduleSectionClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, GcalScheduleSection, all_day_toggle);
  gtk_widget_class_bind_template_child (widget_class, GcalScheduleSection, time_slot_toggle);
...
gcal_schedule_section_init (GcalScheduleSection *self)
{
  ...
  g_signal_connect (self->all_day_toggle,
                    "notify::active",
                    G_CALLBACK (on_schedule_type_changed_cb),
                    self);
  g_signal_connect (self->time_slot_toggle,
                    "notify::active",
                    G_CALLBACK (on_schedule_type_changed_cb),
                    self);
}
